        ...
        <div class="widget__content">
            <ul>
                @foreach($company->cities as $city)
                    <li>
                        <a href="{{secure_url('/')}}/l/{{$city->id}}/{{$city->slug()}}?company_id={{$company->id}}">
        ...
        <div class="widget__content hours_content">
            <ul>
                @foreach($company->brands() as $brand)
                    <li>
                        <a href="{{secure_url('/')}}/b/{{$brand->sync_id}}/{{$brand->slug()}}?company_id={{$company->id}}">
                            <i class="fa fa-check"></i>
        ...
        <div class="widget__content hours_content">
            <ul>
                @foreach($company->types as $type)
                    <li>
                        <a href="{{secure_url('/')}}/t/{{$type->sync_id}}/{{$type->slug()}}?company_id={{$company->id}}">
                            <i class="fa fa-check"></i>
