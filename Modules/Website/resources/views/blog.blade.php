                ...
                <div class="card card-body">
                            <div class="media align-items-center align-items-lg-start  flex-column flex-lg-row">
                                <div class="mr-2 mb-3 mb-lg-0">
                                        ...
                                        <img src="/storage/{{$blog->image}}" width="150" height="150" alt="" style="max-height:150px;width:200px;">
                                   
                                </div>

                                <div class="media-body" style="padding:0px 20px;">
                                    <h6 class="media-title font-weight-semibold">
                                        <a href="{{url('blog-details/'.$blog->id)}}" data-abc="true">{{ $blog->title }}</a>
                                    </h6>
                                    ...
                                    <a href="{{url('blog-details/'.$blog->id)}}" class="btn mt-4 text-white" style="background:#564b89"><i class="icon-cart-add mr-2"></i> {{ __('lang.Read More') }}</a>
