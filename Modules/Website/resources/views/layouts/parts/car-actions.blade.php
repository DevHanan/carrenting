            ...
            <li>
                <a class="car-contact" data-type="whatsapp" data-id="{{$car->id}}" href="{{secure_url('/')}}/a/{{$car->id}}?type=whatsapp" data-toggle="tooltip" data-placement="top" title="{{$car->company->phone_02}}">
